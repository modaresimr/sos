 ...
 */
public abstract class StandardWorldModel extends DefaultWorldModel<StandardEntity> {
	/* ///////////////////S.O.S instants////////////////// */
...
//		storedTypes = new EnumMap<StandardEntityURN, Collection<StandardEntity>>(StandardEntityURN.class);
	...
	public void UpdateHumanRectangles() {
...
//	}
	...
	//	 */
	//	private Collection<StandardEntity> getObjectsInRange(EntityID entity, int range) {
	...
	//	 * @return A collection of StandardEntitys that are within range.
	//	 */
	//	private Collection<StandardEntity> getObjectsInRange(StandardEntity entity, int range) {
	...
	//	 * @return A collection of StandardEntitys that are within range.
	//	 */
	//	private Collection<StandardEntity> getObjectsInRange(int x, int y, int range) {
	//		if (!indexed) {
	//			index();
	//		}
...
//	}
	...
	public int getDistance(StandardEntity first, StandardEntity second) {
		Pair<Integer, Integer> a = first.getLocation();
		Pair<Integer, Integer> b = second.getLocation();
		if (a == null || b == null) {
			return -1;
		}
		return distance(a, b);
	...
	public Rectangle2D getBounds() {
		if (bound == null) {
			...
			bound = new Rectangle2D.Double(minX, minY, maxX - minX, maxY - minY);
		}
		return bound;
	}
	...
	private Rectangle makeRectangle(StandardEntity e) {
		...
		if (e instanceof Area) {
			...
			Human h = (Human) e;
			Point2D location = h.getPositionPoint();
			if (location == null) {
				return null;
			}
			x1 = location.getIntX();
			...
			System.err.println("unknown entity passed to make rectangle");
...
//			}
	...
	// DON'T ADD ANY instant or method HEAR!!!!!!
		public abstract ArrayList<Civilian> civilians();
		// DON'T ADD ANY instant or method HEAR!!!!!!
		public abstract ArrayList<Human> humans();
		 ...
		 */
		public abstract List<Human> agents();
		 ...
		 */
		public abstract List<FireBrigade> fireBrigades();
		 ...
		 */
		public abstract List<PoliceForce> policeForces();
		 ...
		 */
		public abstract List<AmbulanceTeam> ambulanceTeams();
		 ...
		 */
		public abstract List<Center> centers();
		 ...
		 */
		public abstract List<Building> buildings();
		 ...
		 */
		public abstract List<Road> roads();

		// DON'T ADD ANY instant or method HEAR!!!!!!
		public abstract List<Refuge> refuges();

		// DON'T ADD ANY instant or method HEAR!!!!!!
		public abstract ArrayList<Blockade> blockades();
		...
		public abstract StandardEntity me() ;
