...
public class NotSearchedForCivlianCluster extends SOSAbstractToolsLayer<ClusterData> {

	public NotSearchedForCivlianCluster() {
	...
	protected void makeEntities() {
		setEntities(model().sosAgent().getMyClusterData());
	}
