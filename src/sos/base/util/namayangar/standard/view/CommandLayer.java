...
import sos.base.util.namayangar.misc.gui.DrawingTools;
...
public class CommandLayer extends StandardViewLayer {
	...
	private void renderExtinguish(AKExtinguish ex) {
		...
		Pair<Integer, Integer> fbLocation = fb.getLocation();
		Pair<Integer, Integer> targetLocation = target.getLocation();
	...
	private void renderClear(AKClearArea clear) {
