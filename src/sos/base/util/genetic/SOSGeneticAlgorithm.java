 ...
 */
public class SOSGeneticAlgorithm {
	...
	private SOSSelectionPolicy sosSelect;
	 ...
	 */
	public SOSGeneticAlgorithm(final CrossoverPolicy crossoverPolicy,
			final double crossoverRate,
			final MutationPolicy mutationPolicy,
			final double mutationRate,
			final SelectionPolicy selectionPolicy, final SOSSelectionPolicy sosSelect) throws OutOfRangeException {
	 ...
	 *            random generator
	 */
	public synchronized void setRandomGenerator(final RandomGenerator random) {
	 ...
	 * 
	 * @return the random generator shared by GA implementation classes
	 */
