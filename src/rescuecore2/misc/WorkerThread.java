...
public abstract class WorkerThread extends Thread {
    ...
    */
    public WorkerThread() {
        running = true;
        killed = false;
        setName("[Rescue]"+this.getClass().getSimpleName());
    }
            ...
            while (isRunning()) {
                try {
                	...
                	if(LaunchAgents.splash!=null)
                		LaunchAgents.splash.exit();
//                	JOptionPane.showMessageDialog(null, "Precompute has some error","Error",0);
                }
            }
        }
        finally {
	 ...
	 * @throws Exception
	 */
    protected abstract boolean work() throws InterruptedException, Exception;
